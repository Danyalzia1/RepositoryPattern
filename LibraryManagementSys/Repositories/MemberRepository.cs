...
namespace LibraryManagementSys.Repositories
{
    ...
    {
        ICollection<Member> _members=new List<Member>() { new Member { Id=1,MName="Faraz",MContact="0333-0000001",MType="Staff",MNoOfBookIssued=2} ,
        ...
        public MemberRepository(LibraryDbContext db) : base(db)
        {
        }
    }
}
